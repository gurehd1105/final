...
public class EmployeeService {
    ...
    public int insertEmployee(EmployeeForm employeeForm) {
        ...
        employeeDetailSuccess =
            employeeMapper.insertEmployeeDetail(employeeDetail) == 1;
    ...
    public int deleteEmployee(Employee employee) {
        ...
        if (check != null) {
            log.info("PW 확인");
            employeeSuccess =
                employeeMapper.updateEmployeeActive(employee) == 1;
            employeeDetailSuccess =
                employeeMapper.deleteEmployeeDetail(employee) == 1;
            employeeImgSuccess =
                employeeMapper.deleteEmployeeImg(employee) == 1;
        }
    ...
    public boolean updateEmployee(EmployeeForm form) {
        ...
        employeeDetailSuccess =
            employeeMapper.updateEmployeeOne(employeeDetail) == 1;
        ...
        if (employeeImgSuccess == false) {
            employeeImgSuccess =
                employeeMapper.insertEmployeeImg(employeeImg) == 1;
        }
    ...
    public List<String> selectAllEmployeeImage() {
        return employeeMapper.selectAllEmployeeImage();
    }
}
