...
public class CommonAspect {
	...
	@Around("execution(String com.example.gym..*Controller.*(..)) && @annotation(org.springframework.web.bind.annotation.GetMapping)")
		...
		for (Object arg : args) {
			if (arg instanceof Model) {
				...
				if (loginEmployee != null) {
					model.addAttribute("question_notyet", questionService.countNotYet());
					model.addAttribute("order_notyet", seService.countNotYetOrder());
				}
			}
		}
