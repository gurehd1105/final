        ...
        data() {
            return {
                ...
                urls: {
                    ...
                    "1-4-1": ["${ctp}/employee/program/insert"],
                    "1-4-2": ["${ctp}/employee/program/list", "${ctp}/program/update"],
                    "1-4-3": [
                        "${ctp}/employee/programDate/list",
                        "${ctp}/employee/programDate/update",
                        "${ctp}/programDate/insert",
                    ],
                    "1-5-1": ["${ctp}/employee/sportsEquipment/insert"],
                    "1-5-2": ["${ctp}/employee/sportsEquipment/orderByHead"],
                    "1-5-3": ["${ctp}/employee/sportsEquipment/inventoryByHead"],
                    "1-5-4": [
                        "${ctp}/employee/sportsEquipment/list",
                        "${ctp}/employee/sportsEquipment/sportsEquipmentOne",
                    ],
                    "1-5-5": ["${ctp}/employee/sportsEquipment/orderByBranch"],
                    "1-5-6": ["${ctp}/employee/sportsEquipment/inventoryByBranch"],
